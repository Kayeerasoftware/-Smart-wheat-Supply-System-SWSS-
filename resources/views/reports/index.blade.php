        ...
        <div class="mb-8">
            <div class="flex justify-between items-center">
                ...
                <div class="flex space-x-3">
                    ...
                    <div class="relative" x-data="{ open: false, selectedInterval: 'weekly', isEnabled: false }">
                        <button @click="open = !open" class="btn-primary inline-flex items-center px-6 py-3 rounded-xl font-semibold text-sm text-white uppercase tracking-wider">
                            <i class="fas fa-robot mr-2"></i>
                            Auto Reports
                            <i class="fas fa-chevron-down ml-2"></i>
                        </button>
                        <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-80 bg-gray-800 rounded-lg shadow-lg z-50 border border-gray-700">
                            <div class="p-4">
                                ...
                                <div class="flex items-center justify-between mb-4">
                                    <span class="text-sm text-gray-300">Enable Auto Reports</span>
                                    <label class="relative inline-flex items-center cursor-pointer">
                                        <input type="checkbox" x-model="isEnabled" class="sr-only peer">
                                ...
                                <div class="mb-4">
                                    <label class="block text-sm text-gray-300 mb-2">Report Frequency</label>
                                    <select x-model="selectedInterval" class="w-full bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5">
                                ...
                                <!-- Report Types -->
                                <div class="mb-4">
                                    <label class="block text-sm text-gray-300 mb-2">Report Types</label>
                                    <div class="space-y-2">
                                        <label class="flex items-center">
                                            <input type="checkbox" checked class="w-4 h-4 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500 focus:ring-2">
                                            <span class="ml-2 text-sm text-gray-300">Inventory Reports</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" checked class="w-4 h-4 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500 focus:ring-2">
                                            <span class="ml-2 text-sm text-gray-300">Order Reports</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" checked class="w-4 h-4 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500 focus:ring-2">
                                            <span class="ml-2 text-sm text-gray-300">Financial Reports</span>
                                        </label>
                                        <label class="flex items-center">
                                            <input type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-700 border-gray-600 rounded focus:ring-blue-500 focus:ring-2">
                                            <span class="ml-2 text-sm text-gray-300">Performance Reports</span>
                                        </label>
                                    </div>
                                </div>
                                ...
                                <!-- Delivery Method -->
                                <div class="mb-4">
                                    <label class="block text-sm text-gray-300 mb-2">Delivery Method</label>
                                    <select class="w-full bg-gray-700 border border-gray-600 text-white text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 p-2.5">
                                ...
                                <div class="bg-gray-700 rounded-lg p-3 mb-4">
                                    <div class="flex items-center text-sm text-gray-300">
                                        ...
                                        <span x-text="isEnabled ? `Next report: ${selectedInterval === 'daily' ? 'Tomorrow' : selectedInterval === 'weekly' ? 'Next Monday' : selectedInterval === 'monthly' ? 'Next Month' : selectedInterval === 'quarterly' ? 'Next Quarter' : 'Next Year'}` : 'Auto reports disabled'"></span>
                                    </div>
                                </div>

                                <!-- Action Buttons -->
                                <div class="flex space-x-2">
                                    <button @click="open = false" class="flex-1 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors">
                                        Save Settings
                                    </button>
                                    <button @click="open = false" class="bg-gray-600 hover:bg-gray-700 text-white text-sm font-medium py-2 px-4 rounded-lg transition-colors">
                                        Cancel
                                    </button>
                                </div>
                            </div>
                    ...
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open" @click.away="open = false" x-transition class="absolute right-0 mt-2 w-48 bg-gray-800 rounded-lg shadow-lg z-50">
                            <div class="py-1">
                                <a href="/reports/export/pdf" class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors">
                                    <i class="fas fa-file-pdf mr-3 text-red-400"></i>
                                    Export as PDF
                                </a>
                                <a href="/reports/export/excel" class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors">
                                    <i class="fas fa-file-excel mr-3 text-green-400"></i>
                                    Export as Excel
                                </a>
                                <a href="/reports/export/csv" class="flex items-center px-4 py-2 text-sm text-gray-300 hover:bg-gray-700 hover:text-white transition-colors">
