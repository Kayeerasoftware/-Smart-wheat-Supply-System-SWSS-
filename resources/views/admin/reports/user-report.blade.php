    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6 main-content">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-3xl md:text-4xl font-bold font-space gradient-text">User Report</h1>
            ...
            @if(isset($users) && $users->count())
                <div class="glass-card p-8 rounded-2xl shadow-lg">
                    <table class="min-w-full divide-y divide-gray-700">
                        <thead>
                            <tr>
                                <th class="px-4 py-2 text-left text-xs font-bold text-gray-200 uppercase">Username</th>
                                <th class="px-4 py-2 text-left text-xs font-bold text-gray-200 uppercase">Email</th>
                                <th class="px-4 py-2 text-left text-xs font-bold text-gray-200 uppercase">Role</th>
                                <th class="px-4 py-2 text-left text-xs font-bold text-gray-200 uppercase">Activity Count</th>
                            </tr>
                        </thead>
                        <tbody class="divide-y divide-gray-800">
                            @foreach($users as $user)
                                <tr>
                                    ...
                                    <td class="px-4 py-2 text-gray-300">{{ $user->role }}</td>
                                    <td class="px-4 py-2 text-gray-300">{{ $user->activities->count() }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
