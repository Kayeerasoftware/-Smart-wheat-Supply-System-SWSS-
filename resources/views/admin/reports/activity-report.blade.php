    ...
    <div class="flex">
        ...
        <main class="flex-1 p-6 main-content">
            <div class="flex justify-between items-center mb-8">
                <h1 class="text-3xl md:text-4xl font-bold font-space gradient-text">Activity Report</h1>
                    ...
                    <table class="min-w-full divide-y divide-gray-700">
                        ...
                        <tbody class="divide-y divide-gray-800">
                            @foreach($activities as $activity)
                                <tr>
                                    <td class="px-4 py-2 text-gray-300">{{ $activity->user->username ?? 'System' }}</td>
                                    <td class="px-4 py-2 text-gray-300">{{ ucfirst($activity->type) }}</td>
                                    <td class="px-4 py-2 text-gray-300">{{ $activity->description }}</td>
                                    <td class="px-4 py-2 text-gray-300">{{ $activity->created_at->format('Y-m-d H:i') }}</td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
