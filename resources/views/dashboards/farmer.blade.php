{{-- Use the supplier layout as a base for consistency --}}
...
{{-- Remove the navbar section for farmers --}}
{{-- @section('navbar') --}}
...
<div class="flex min-h-screen bg-gradient-to-br from-indigo-700 via-purple-700 to-indigo-900">
    ...
    <div class="flex-1 flex flex-col">
        ...
        <main class="p-8">
            ...
            {{-- Example: stats cards, charts, recent activity, etc. --}}
            @include('dashboards.partials.farmer-dashboard-content')
            </main>
    </div>
</div>
@endsection 