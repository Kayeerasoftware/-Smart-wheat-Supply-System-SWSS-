...
<head>
    ...
    <title>SWSS Supplier Dashboard - Pending Approval</title>
...
<body class="text-white overflow-x-hidden">
    ...
    <main class="main-content p-6">
        ...
        <div class="mb-8">
            ...
            <p class="mt-2 text-lg text-gray-300">{{ $statusMessage }}</p>
        </div>
        ...
        <!-- Application Details -->
        <div class="glass-card p-8 mb-8">
            <h2 class="text-2xl font-bold font-space mb-6 gradient-text">Application Details</h2>
                ...
                <div>
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center py-2 border-b border-gray-700">
                            <span class="text-gray-300">Business Name:</span>
                            <span class="text-white font-medium">{{ $vendor->application_data['business_name'] ?? 'Not provided' }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-gray-700">
                            <span class="text-gray-300">Business Type:</span>
                            <span class="text-white font-medium">{{ $vendor->application_data['business_type'] ?? 'Not provided' }}</span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-gray-700">
                            <span class="text-gray-300">Description:</span>
                            <span class="text-white font-medium">{{ Str::limit($vendor->application_data['business_description'] ?? 'Not provided', 50) }}</span>
                        </div>
                    </div>
                </div>
                <div>
                    ...
                    <div class="space-y-3">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-gray-700">
                            ...
                            <span class="text-white font-medium">{{ ucfirst(str_replace('_', ' ', $vendor->processing_status)) }}</span>
                        </div>
                    </div>
                </div>
            </div>
