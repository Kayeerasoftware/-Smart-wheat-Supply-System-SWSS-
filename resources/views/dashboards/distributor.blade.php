    ...
    <div class="row">
        <nav class="col-md-2 d-none d-md-block bg-dark sidebar text-white">
            <div class="sidebar-sticky">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white" href="#">Deliveries</a>
                    </li>
                    <li class="nav-item">
        ...
        <main class="col-md-10 ms-sm-auto px-4">
            <nav class="navbar navbar-light bg-light mb-4">
                <span class="navbar-brand">Distributor Dashboard</span>
                <div>
                    <span class="me-3">Welcome, {{ Auth::user()->username }}</span>
                    <span class="badge bg-primary">Distributor</span>
                </div>
            </nav>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-warning mb-2">Schedule Delivery</a>
