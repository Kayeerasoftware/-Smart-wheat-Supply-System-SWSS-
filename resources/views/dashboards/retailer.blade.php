...
<div class="dashboard-wrapper">
    ...
    <div class="row">
            ...
            <main class="col-md-10 ms-sm-auto main-content">
                ...
                <div>
                        <h4 class="mb-0" style="color: #2d3748; font-weight: 700;">Retailer Dashboard</h4>
                        <small class="text-muted">Manage sales, inventory, and customer insights</small>
                    </div>
                    <div class="d-flex align-items-center">
                        <span class="welcome-text">Welcome, {{ Auth::user()->username }}</span>
                        <span class="user-badge">Retailer</span>
                </div>
            </nav>

                <div class="px-4 pb-4">
                    <!-- Sales and Customer Row -->
            <div class="row mb-4">
                        <div class="col-md-6 mb-3">
                            <div class="sales-card">
                                <h5 class="mb-2">Today's Sales</h5>
                                <h3 class="mb-2">${{ $todaySales ?? 2,450 }}</h3>
                                <p class="mb-2">{{ $transactions ?? 45 }} transactions today</p>
                                <div class="d-flex justify-content-between">
                                    <span>Avg. Transaction: $54</span>
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <h5>Total Inventory</h5>
                                    <h2>{{ $totalInventory ?? 120 }}<small style="font-size: 1rem; color: #718096;"> tons</small></h2>
                        </div>
                    </div>
                </div>
            </div>
                ...
                <div class="col-md-8">
                            <div class="card content-card">
                                <div class="card-header">
                                    <i class="bi bi-activity me-2"></i>Sales Activity
                                </div>
                        <div class="card-body">
                            @forelse ($recentActivity as $activity)
                                <div class="activity-item">
                                            <div class="d-flex justify-content-between align-items-start">
                                                ...
                                                <span class="badge bg-light text-dark">Sale</span>
                                            </div>
                                </div>
                            @empty
                                        <div class="text-center py-4">
                                            ...
                                            <small class="text-muted">Your sales activities will appear here</small>
                                        </div>
                            @endforelse
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                                    <div class="d-grid gap-3">
                                        <a href="#" class="btn-modern">
                                            <i class="bi bi-cash-register me-2"></i>New Sale
                                        </a>
                                        <a href="#" class="btn-modern">
